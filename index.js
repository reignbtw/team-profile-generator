...
const promptManager = () => {
    return inquirer.prompt([
        ...
        },
        {
            type: 'input',
            name: 'employeeId',
            message: 'Please enter your employee IID (Required)',
            validate: employeeId => {
                if (employeeId) {
                    return true;
                } else {
    ...
    return inquirer.prompt([
        {
            type: 'list',
            name: 'menu',
            message: 'Please select which option you want to continue with:',
...
const promptIntern = () => {
    ...
    return inquirer.prompt([
        ...
        console.log(answers);
        const intern = new Intern(answers.name, answers.employeeId, answers.enail, answers.school);
